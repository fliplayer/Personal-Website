...
Rabbit.outside.prototype = {
	create: function(){
		...
		this._house = this.add.sprite(this.world.width-280, this.world.height- 260, 'house');
		this.physics.arcade.enable(this._house);
		this._house.scale.setTo(7,7);
		this._house.body.moves = false;
	...
	update: function() {
		...
		this.physics.arcade.overlap(this._player, this._house, this.proceed, null, this);
