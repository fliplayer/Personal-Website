Rabbit.eleventhStage = function(game){
...
Rabbit.eleventhStage.prototype = {
	create: function(){
		...
		var platform3 = this._platforms.create(this.world.width -200, this.world.height-350, 'ground');
		platform3.scale.setTo(0.8,5);
		...
		this._gun = this.add.sprite(this.world.width - 140, 100, 'gun');
		this._gun.scale.setTo(2,2);
		this.physics.arcade.enable(this._gun);
		this._gun.body.gravity.y = 1000;
		this._gun.body.bounce.set(0.4);
